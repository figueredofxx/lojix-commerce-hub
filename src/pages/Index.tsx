      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#4141e1] via-[#5b5bf6] to-[#6366f1] min-h-screen flex items-center">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#4141e1]/5 to-transparent"></div>
          </div>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            {/* Testimonial */}
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-12 text-center max-w-4xl mx-auto shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <Card className="bg-white border-0 shadow-xl rounded-3xl overflow-hidden">
                ...
                <CardContent className="space-y-8 p-8">
                  ...
                  <Button
                    className="w-full bg-gradient-to-r from-[#4141e1] to-[#6366f1] hover:opacity-90 text-white font-semibold py-6 text-lg rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg"
              ...
              <Card className="bg-white border-0 shadow-2xl rounded-3xl overflow-hidden relative transform scale-105">
                ...
                <CardContent className="space-y-8 p-8">
                  ...
                  <Button
                    className="w-full bg-gradient-to-r from-[#4141e1] to-[#6366f1] hover:opacity-90 text-white font-semibold py-6 text-lg rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl"
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-2xl mx-auto">
                <Button
                  className="bg-gradient-to-r from-[#4141e1] to-[#6366f1] hover:opacity-90 text-white font-semibold px-10 py-6 text-lg rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl flex-1 sm:flex-initial"
                  onClick={() => window.location.href = '/cadastro'}
                >
                  {t('finalCta.primary')}
                  <ArrowRight className="ml-2 h-5 w-5" />
